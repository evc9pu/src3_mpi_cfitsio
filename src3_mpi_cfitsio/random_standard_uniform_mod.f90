...
! history:
! 2012/03/22 (mjw):  convert random_standard_uniform to double precision
!
!
...
!        REAL :: random_standard_uniform
        real (kind=kind(1.d0)) :: random_standard_uniform
! ..
...
!      and is currently 2147483563. If M1 changes, change this also.
        random_standard_uniform = random_large_integer()*4.656613057d-10
        RETURN
