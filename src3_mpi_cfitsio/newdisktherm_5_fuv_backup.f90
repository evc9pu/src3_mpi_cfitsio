...
! ************************************************************
  ...
  ! some scalars
  call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(icount),1,MPI_INTEGER,MPI_SUM,MPI_COMM_WORLD,ierr)
  call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(np),1,MPI_INTEGER,MPI_SUM,MPI_COMM_WORLD,ierr)
  call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(dscount),1,MPI_DOUBLE_PRECISION,MPI_SUM,MPI_COMM_WORLD,ierr)
  call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(scount),1,MPI_DOUBLE_PRECISION,MPI_SUM,MPI_COMM_WORLD,ierr)
...
! KILLED (reset before each call to DISK)
  ...
  call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(killed),icountbuf,MPI_INTEGER,MPI_SUM,MPI_COMM_WORLD,ierr)
...
! JMEAN not needed as it is calculated from DBIG and DSG
  icountbuf = nrg*ntg*npg
  call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(nabs(1,1,1)),icountbuf,MPI_INTEGER,MPI_SUM,MPI_COMM_WORLD,ierr)
  call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(dtauabs(1,1,1)),icountbuf,MPI_DOUBLE_PRECISION,MPI_SUM,MPI_COMM_WORLD,ierr)
  call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(dbig(1,1,1)),icountbuf,MPI_INTEGER,MPI_SUM,MPI_COMM_WORLD,ierr)
  call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(dsg(1,1,1)),icountbuf,MPI_INTEGER,MPI_SUM,MPI_COMM_WORLD,ierr)
  call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(jmean(1,1,1)),icountbuf,MPI_DOUBLE_PRECISION,MPI_SUM,MPI_COMM_WORLD,ierr)
  call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(fuvmean(1,1,1)),icountbuf,MPI_DOUBLE_PRECISION,MPI_SUM,MPI_COMM_WORLD,ierr) ! note fuvmean includes energy per photon
  call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(tdust(1,1,1)),icountbuf,MPI_DOUBLE_PRECISION,MPI_SUM,MPI_COMM_WORLD,ierr)
...
! SI,SQ,SU,SV,SI2,SQ2,SU2,SV2,NUMS (these are reset before each call to DISK)
  ...
  call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(si(1,1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
  call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(sq(1,1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
  call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(su(1,1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
  call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(sv(1,1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
  call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(si2(1,1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
  call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(sq2(1,1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
  call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(su2(1,1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
  call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(sv2(1,1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
  call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(nums(1,1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
 ...
 ! do reduction for arrays available only when temperature is converged
  if (converge.eq.'yes') then
     ...
     call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(ti(1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
     call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(tq(1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
     call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(tu(1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
     call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(tv(1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
     call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(ti2(1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
     call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(tq2(1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
     call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(tu2(1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
     call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(tv2(1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
     call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(numt(1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
...
! broadband peeloff IMAGES
     if(output_imfilt) then
        ...
        call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(image_b_i(1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
        call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(image_b_q(1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
        call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(image_b_u(1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
        call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(image_b_v(1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
        call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(image_b_d(1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
        call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(image_b_s(1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
        call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(image_b_e(1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
        call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(image_b_o(1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
     endif
     
     if(output_imcube) then
        ! monochromatic peeloff IMAGES
        icountbuf = npeel*nxhst*nxhst*nfreq
        call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(image_m_i(1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
        icountbuf = npeel*nxhst*nxhst*nfreq
        call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(image_m_q(1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
        call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(image_m_u(1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
        call MPI_ALLREDUCE(MPI_IN_PLACE,c_loc(image_m_v(1,1,1,1)),icountbuf,MPI_REAL,MPI_SUM,MPI_COMM_WORLD,ierr)
     endif
  end if
