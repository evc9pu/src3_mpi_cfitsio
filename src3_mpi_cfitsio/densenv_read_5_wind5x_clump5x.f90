subroutine densenv_read(rad,thetin,costin,sina,phi,lor,upr,lot,upt,denll,denuu,denlu,denul,dens,radamb,id,inhole,x0,vz,vcyn,ir,it)
  ...
  real(8) :: rx2,xmu0new,zlo,zp,radamb,x0,vz,vcyn
...
!  endif
  ...
  call densdiskwind(rp,zp,densw,x0,vz,vcyn,ir,it)
...
!  endif
  ...
  if (rad.ge.rmax.and.inhole.eq.0) dens=0.d0
  if (rad.ge.rmax/5.d0.and.rad.lt.and.inhole.eq.0) dens=rhoamb
